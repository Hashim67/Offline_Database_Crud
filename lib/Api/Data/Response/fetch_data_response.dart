...
// //       setCategoryList(ApiResponse.completed(categories.data!.cast<CategoryModel>()));
// //     } else {
// //       // Handle the case where categories are fetched successfully but are empty
// //       setCategoryList(ApiResponse.completed([]));
// //     }
// //   } catch (error) {
// //     print('Error fetching or storing categories: $error');
// //     setCategoryList(ApiResponse.error(error.toString()));
// //   }
...
//       // Store the fetched categories in the database
//       await SQLHelper.storeCategories(categories.data!.cast<DatabaseCategoryModel>() as CategoryModel);
